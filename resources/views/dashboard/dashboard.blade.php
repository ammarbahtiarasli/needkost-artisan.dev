<x-app-layout>
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    {{ __('Kamu masuk sebagai ' . Auth::user()->role->nama) }}
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="pt-6 mx-auto max-w-7xl sm:px-6 lg:px-8 md:hidden">
        <div class="overflow-hidden transition shadow-sm bg-red-300/80 dark:bg-emerald-400/80 sm:rounded-lg">
    ...
    <div class="px-4 py-4 mx-auto lg:py-12 sm:px-6 md:px-4 lg:max-w-6xl xl:max-w-7xl lg:px-8">
        ...
        <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            <div
                ...
                <h4 class="font-mono text-xl">{{ $kosts }}</h4><small
                    class="block mt-4 text-sm text-muted-foreground">Kamar
                    Kost</small>
    ...
    <div class="px-4 py-4 mx-auto bg-red-400 lg:py-12 sm:px-6 md:px-4 lg:max-w-6xl xl:max-w-7xl lg:px-8">
        <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
            <div class="flex p-6 text-gray-900 dark:text-gray-100">
                <div class="container w-1/2">
                    <h3 class="text-xl font-semibold leading-6 tracking-tighter dark:text-gray-200">Kost yang sedang
                        disewa
                    </h3>
                    ...
                    <tr
                        ...
                        <th scope="row"
                            ...
                            <img class="w-10 h-10 rounded-full"
                                ...
                                alt="Jese image">
                            <div class="ps-3">
                                <div class="text-base font-semibold">Kost Babeh</div>
    ...
    <div class="px-4 py-4 mx-auto bg-red-400 lg:py-12 sm:px-6 md:px-4 lg:max-w-6xl xl:max-w-7xl lg:px-8">
        <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
            <div class="flex p-6 text-gray-900 dark:text-gray-100">
                <div class="container w-1/2">
                    <h3 class="text-xl font-semibold leading-6 tracking-tighter dark:text-gray-200">Pengguna yang sedang
                        menyewa kost
                    </h3>
