        ...
        <div class="px-4 mx-auto sm:px-6 md:px-4 lg:px-8 lg:max-w-6xl xl:max-w-7xl">
            <div class="space-y-10 sm:space-y-24">
                <section id="rekomendasi">
                    <div class="mb-6">
                        <h2 class="text-xl font-semibold leading-6 tracking-tight dark:text-gray-200">Kota {{ $kota }}</h2>
                        <p class="text-sm dark:text-gray-300 text-muted-foreground">{{ $kosts->count() }} Kostan di Kota
                            {{ $kota }}.</p>
                    </div>
                    @if ($kosts->count() == 0)
                        <div class="flex items-center justify-center w-full">
                            <p class="mt-4 text-lg text-rose-400">Kamar kost di {{ $kota }} tidak ditemukan.</p>
                        </div>
                    @else
                        <div
